# Biotrackr Vitals Service Integration Tests

Integration test suite for the Biotrackr Vitals Service that verifies end-to-end workflows and service integration points.

## Overview

This project contains comprehensive integration tests for `Biotrackr.Vitals.Svc`, organized into two categories:
...
```
Biotrackr.Vitals.Svc.IntegrationTests/
...
│   ├── VitalsWorkerTests.cs           # Complete workflow tests
│   ├── VitalsServiceTests.cs          # Service integration tests
