...
namespace Biotrackr.Vitals.Svc.IntegrationTests.Contract
{
    ...
    public class ProgramStartupTests
    {
        ...
        public void All_Required_Services_Are_Registered()
        {
            ...
            var vitalsService = serviceProvider.GetService<IVitalsService>();
            ...
            vitalsService.Should().NotBeNull("IVitalsService should be registered");
            vitalsService.Should().BeAssignableTo<IVitalsService>("IVitalsService should resolve to correct implementation");
