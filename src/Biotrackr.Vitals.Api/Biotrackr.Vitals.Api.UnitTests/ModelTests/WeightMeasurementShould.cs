...
namespace Biotrackr.Vitals.Api.UnitTests.ModelTests
{
    public class WeightMeasurementShould
    {
        ...
        [Fact]
        public void DeserializeVitalsDocumentWithProvider()
        {
            var json = """
            {
                "id": "123456789",
            ...
            var result = JsonSerializer.Deserialize<VitalsDocument>(json, options);
        ...
        [Fact]
        public void DeserializeLegacyVitalsDocumentWithoutProvider()
        {
            var json = """
            {
                "id": "some-guid",
