---
description: "Create technology-free feature specification — WHAT and WHY, not HOW"
...
* ${input:slug}: (Optional) Slug from the Explore phase. Inferred from context if omitted.
* ${input:dossier}: (Optional) Path to research dossier from SDD Phase 1.
