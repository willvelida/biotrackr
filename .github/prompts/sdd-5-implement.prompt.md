---
description: "Execute one implementation phase with progress tracking and verification"
...
* ${input:phase}: (Optional, default 1) Phase number to implement.
* ${input:plan}: (Optional) Path to the plan file from Phase 4.
