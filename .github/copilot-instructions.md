...
See `docs/devcontainer-setup.md` for secrets, ports, seed data, and troubleshooting.
...
| Agent                    | File                                                    | Purpose                          |
|--------------------------|---------------------------------------------------------|----------------------------------|
| Agentic Workflows        | `.github/agents/agentic-workflows.agent.md`             | GH-AW workflow authoring         |
